...
- **CLI first for links:** When documenting scriptable URL generation, prefer `@cloudcreate/cli` (`cloudcreate open ...` or `npx @cloudcreate/cli open ...`) so tool keys and query parameters stay aligned with `@cloudcreate/core`.
